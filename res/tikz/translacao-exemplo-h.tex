...
\draw  [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ] (180,161.46) .. controls (183.32,167.42) and (186.65,173.68) .. (190,180) .. controls (206.31,210.74) and (221.9,240) .. (240,240) .. controls (258.1,240) and (273.69,210.74) .. (290,180) .. controls (306.31,149.26) and (321.9,120) .. (340,120) .. controls (358.1,120) and (373.69,149.26) .. (390,180) .. controls (406.31,210.74) and (421.9,240) .. (440,240) .. controls (458.1,240) and (473.69,210.74) .. (490,180) .. controls (493.35,173.68) and (496.68,167.42) .. (500,161.46) ;
...
% Text Node
\draw (470.5,27.5) node [scale=0.7]  {$f( x) =senx$};
% Text Node
