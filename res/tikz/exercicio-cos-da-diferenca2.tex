...
\draw    (330,180) -- (415,290); % quarto quadrante
...
\draw (360,180) arc (0:-305:28); % alfa
\draw (380,180) arc (10:-73:28); % beta

\draw    (415,290) -- (430,81.5); % segmento 
...
% Text Node
\draw (420,300) node [anchor=south west] [inner sep=0.75pt]    {$C$};
