...
\begin{definition}
Uma função $f: X \to Y$ é \textdef{invertível} se existe uma função $g: Y \to X$ tal que:
%
\begin{enumerate}[(i)]
...
\end{enumerate}
%
Nesse caso, a função $g$ é dita \textdef{função inversa} de $f$ e denotada por $g = f^{-1}$.
\end{definition}
...
\begin{onlineact}
    \khan{https://pt.khanacademy.org/math/algebra2/manipulating-functions/verifying-that-functions-are-inverses/e/inverses_of_functions}
