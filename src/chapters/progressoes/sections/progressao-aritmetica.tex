...
\begin{definition}
Uma \textdef{progressão aritmética} --- ou, simplesmente, PA --- é uma sequência na qual a diferença entre um termo, quando este não é o primeiro, e seu anterior  é constante. Essa diferença constante é chamada de \textdef{razão} da progressão e representada pela
letra $r$.
\end{definition}
