...
\begin{solution}
    ...
    \begin{align*}
        a_1 = a_5 \vezes q^{1-5} & \sse 30 = 480 \vezes q^{-4} \\
                                 & \sse q^4 = \frac {480}{30} = 16 \\
                                 & \sse q = \maisoumenos 2.
    \end{align*}
...
\begin{onlineact}
    \khan{https://pt.khanacademy.org/math/algebra/sequences/introduction-to-geometric-sequences/e/geometric_sequences_2}{Use Fórmulas de Progressão Geométrica}.
\end{onlineact}

\begin{onlineact}
    \khan{https://pt.khanacademy.org/math/algebra/sequences/constructing-geometric-sequences/e/explicit-and-recursive-formulas-of-geometric-sequences}{Conversão das Formas Recursiva e Explícita de Progressões Geométricas (no Khan aparece errado como Aritméticas)}.
\end{onlineact}