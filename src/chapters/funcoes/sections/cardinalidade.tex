...
Dois conjuntos $X$ e $Y$ são ditos \textdef{cardinalmente equivalentes}
(ou \textdef{equipotentes}) se existe uma bijeção $f : X \to Y$.
\end{definition}
...
\begin{definition}
Dizemos que um conjunto é \textdef{enumerável} quando ele é cardinalmente equivalente a algum subconjunto de $\N$.
\end{definition}
