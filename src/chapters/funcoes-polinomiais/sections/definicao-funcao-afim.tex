...
\begin{definition}
Uma função real chama-se \textdef{afim} quando existem constantes $a, b
\in \R$ tais que $f(x) = ax +b$ para todo $x\in \R$. 
A constante $a$, em particular, é chamada de \textdef{taxa de variação} ou \textdef{taxa de crescimento} da função.
\end{definition}
