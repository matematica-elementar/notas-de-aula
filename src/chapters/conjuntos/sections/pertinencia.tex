...
Não é correto dizer que $x$ está ``contido'' ou é ``parte'' de $A$, esses termos são usados em matemática com outro sentido, como veremos na Definição~\ref{def:inclusao}.
