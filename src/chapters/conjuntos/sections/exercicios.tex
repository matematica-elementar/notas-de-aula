...
Responda se a sentença abaixo é Verdadeira ou Falsa. No caso de Verdadeira, demonstre-a, ou mostre com um contra-exemplo para o caso de ser Falsa.

Se $C \cup D = A$, então $(A \cup B) \cap (C \cup D) = A \cup (B \cap C) \cup D$.
\end{exercise}
