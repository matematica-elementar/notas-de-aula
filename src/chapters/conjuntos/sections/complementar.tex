...
\begin{proof}
	\begin{enumerate}
		...
		\item
		A seguir demonstraremos as Leis de De Morgan		
			\begin{enumerate}
				\item 
...
\end{tve}
\begin{tve}
	\link{https://drive.google.com/file/d/1FlgqAqmRjWBZWLXoYLWwnTXsQ3rtS_64/view?usp=sharing}{Propriedades de União, Interseção e Leis de De Morgan}.
\end{tve}
\begin{tve}
