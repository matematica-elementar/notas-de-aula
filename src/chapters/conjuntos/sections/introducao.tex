...
\begin{example}
    ...
    O conjunto $P$ dos números primos pares pode ser representado por $P = \conjunto{ x \taisque \text{$x$ é primo e par}} = \unitario{2}$. Tal notação é lida por \entreaspas{o conjunto de todos os $x$'s tais que $x$ é primo e par}. Entre chaves é colocada a representação para o elemento e sua descrição separados por \entreaspas{;}, \entreaspas{\contrabarra}, ou \entreaspas{|}.  Nunca escreva $P = \conjunto{\text{ números primos pares }}$.
\end{example}
