...
\begin{definition}
\label{def:naturais}
Ao conjunto $\N = \set {0, 1, 2, \dots , n, n+1, \dots}$, damos o nome de \emph{conjunto dos números naturais}.
\end{definition}
...
\begin{definition}
Ao conjunto $\Z =\set {\dots , -m -1, -m, \dots, -1, 0, 1,  \dots , n, n+1, \dots}$ damos o nome de \emph{conjunto dos números inteiros}. 
\end{definition}
...
\begin{definition}
Ao conjunto $\Q = \set{p/q \tq p, q \in \Z \text{ e } q \neq 0}$ damos o nome de \emph{conjunto dos números racionais}.
\end{definition}
...
\begin{definition}
Chamamos $i = \sqrt {-1}$ de \emph{número imaginário}, e ao conjunto $\C = \set{ a+bi \tq a,b \in \R}$ damos o nome de \emph{conjunto dos
números complexos}.
\end{definition}
...
\begin{definition}
Seja $a+bi \in \C$. Nomeamos o número $a-bi$ de \emph{conjugado} de $a+bi$.
\end{definition}