...
\begin{solution}
	...
	\begin{itemize}
		...
		\begin{center}
		\importtikz{exemplo-pontos-base}
		\end{center}
		...
		\begin{center}
		\importtikz{exemplo-pontos-indutivo}
		\end{center}
...
\end{example}
\begin{tve}
	\link{https://drive.google.com/file/d/1bnhFScxt-yIoU2oV6gUHjmvQoawAX5Oy/view?usp=sharing}{Exemplo de Demonstração por Indução}.
\end{tve}
...
\begin{proof}
	...
	Para tanto, seja $n \in \naturais\naonulos$ arbitrário.
	Tomemos o menor $m \in \naturais$ tal que $n \le 2^m$.
	...
	Portanto, a desigualdade é válida para todo $n \in \naturais\naonulos$.
\end{proof}